...
public:
    ...
    void attractor(int attractor_num);  // 设置棘轮吸附模式
    void attractor_with_rebound(int attractor_num, float left_rad, float right_rad); // 设置棘轮吸附模式，超出边界后反弹 (
    void damping(float damping_gain);   // 设置阻尼模式 damping_gain 阻尼系数
